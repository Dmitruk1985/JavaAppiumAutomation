...
public class MyListsPageObject extends MainPageObject {
    ...
    public static final String
            ...
            OPTIONS_BUTTON_BY_TITLE = "//*[@resource-id='org.wikipedia:id/page_list_item_title' and @text='{TITLE}']" +
                    "/ancestor::*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@content-desc='More options']",
            DELETE_ARTICLE_OPTION = "org.wikipedia:id/reading_list_item_remove_text";
    ...
    public void openFolderByName(String name_of_folder) {
        ...
        this.waitForElementAndClick(By.xpath(folder_xpath),

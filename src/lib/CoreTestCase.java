...
public class CoreTestCase extends TestCase {
    ...
    private AppiumDriver getDriverByPlatformEnv(DesiredCapabilities capabilities) throws Exception {
        ...
        AppiumDriver driver;
        if (platform.equals(PLATFORM_ANDROID)) driver = new AndroidDriver(new URL(AppiumURL), capabilities);
        else if (platform.equals(PLATFORM_IOS)) driver = new IOSDriver(new URL(AppiumURL), capabilities);
        else throw new Exception("Can't get run platform from env variable. Platform value: " + platform);
        return driver;
    }
